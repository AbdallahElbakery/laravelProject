...
<div class="container py-5">
        <div class="form-container">
            <div class="form-header">
                <h2 class="mb-0"><i class="fas fa-folder-plus me-2 text-primary"></i>Add New Category</h2>
            ...
            <form>
                ...
                <fieldset class="mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="description" rows="3" placeholder="Enter a brief description of this category"></textarea>
